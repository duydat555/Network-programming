...
public class RomanceGenreForm extends Form {

    private JPanel contentPanel;
    private JScrollPane scroll;
    private static final Long GENRE_ID = 4L; // Tình cảm

    public RomanceGenreForm() {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Phim Tình cảm");
