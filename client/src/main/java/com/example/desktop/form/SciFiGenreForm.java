...
public class SciFiGenreForm extends Form {

    private JPanel contentPanel;
    private JScrollPane scroll;
    private static final Long GENRE_ID = 2L; // Viễn tưởng

    public SciFiGenreForm() {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Phim Viễn tưởng");
