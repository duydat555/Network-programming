...
public class AnimationGenreForm extends Form {

    private JPanel contentPanel;
    private JScrollPane scroll;
    private static final Long GENRE_ID = 5L; // Hoạt hình

    public AnimationGenreForm() {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Phim Hoạt hình");
