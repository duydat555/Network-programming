...
public class ActionGenreForm extends Form {

    private JPanel contentPanel;
    private JScrollPane scroll;
    private static final Long GENRE_ID = 1L; // Hành động

    public ActionGenreForm() {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Phim Hành động");
