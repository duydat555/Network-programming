...
public class HistoryGenreForm extends Form {

    private JPanel contentPanel;
    private JScrollPane scroll;
    private static final Long GENRE_ID = 6L; // Lịch sử

    public HistoryGenreForm() {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Phim Lịch sử");
